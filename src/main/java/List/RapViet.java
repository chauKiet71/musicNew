...
public class RapViet extends javax.swing.JPanel {
    ...
    public void init() {
        listChill1.addItem(new Model_Chill(new ImageIcon(getClass().getResource("/icon/rap/1.jpg")), "Rap Việt Ngày Nay"));
        listChill2.addItem(new Model_Chill(new ImageIcon(getClass().getResource("/icon/rap/5.jpg")), "Ơ, Động Đất À!"));
        listChill3.addItem(new Model_Chill(new ImageIcon(getClass().getResource("/icon/rap/2.jpg")), "Gia Vị Rap Việt"));
        listChill4.addItem(new Model_Chill(new ImageIcon(getClass().getResource("/icon/rap/6.jpg")), "Đây Là Rap Love"));
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Rap Việt Cực Chất");
