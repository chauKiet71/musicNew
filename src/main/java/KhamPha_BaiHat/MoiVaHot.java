...
public class MoiVaHot extends javax.swing.JPanel {
    ...
    public void init(){
        listBaiHat1.addItem( new Model_BaiHat(new ImageIcon(getClass().getResource("/icon/KhamPha/mh1.jpg")), "Cục Vợ Ơi, Lấy Anh Nha","Gin Tuấn Kiệt, Puka"));
        listBaiHat2.addItem( new Model_BaiHat(new ImageIcon(getClass().getResource("/icon/KhamPha/mh1.jpg")), "Cục Vợ Ơi, Lấy Anh Nha","Gin Tuấn Kiệt, Puka"));
        listBaiHat3.addItem( new Model_BaiHat(new ImageIcon(getClass().getResource("/icon/KhamPha/mh1.jpg")), "Cục Vợ Ơi, Lấy Anh Nha","Gin Tuấn Kiệt, Puka"));
        listBaiHat4.addItem( new Model_BaiHat(new ImageIcon(getClass().getResource("/icon/KhamPha/mh1.jpg")), "Cục Vợ Ơi, Lấy Anh Nha","Gin Tuấn Kiệt, Puka"));
        listBaiHat5.addItem( new Model_BaiHat(new ImageIcon(getClass().getResource("/icon/KhamPha/mh1.jpg")), "Cục Vợ Ơi, Lấy Anh Nha","Gin Tuấn Kiệt, Puka"));
        listBaiHat6.addItem( new Model_BaiHat(new ImageIcon(getClass().getResource("/icon/KhamPha/mh1.jpg")), "Cục Vợ Ơi, Lấy Anh Nha","Gin Tuấn Kiệt, Puka"));
        listBaiHat7.addItem( new Model_BaiHat(new ImageIcon(getClass().getResource("/icon/KhamPha/mh1.jpg")), "Cục Vợ Ơi, Lấy Anh Nha","Gin Tuấn Kiệt, Puka"));
        listBaiHat8.addItem( new Model_BaiHat(new ImageIcon(getClass().getResource("/icon/KhamPha/mh1.jpg")), "Cục Vợ Ơi, Lấy Anh Nha","Gin Tuấn Kiệt, Puka"));
        listBaiHat9.addItem( new Model_BaiHat(new ImageIcon(getClass().getResource("/icon/KhamPha/mh1.jpg")), "Cục Vợ Ơi, Lấy Anh Nha","Gin Tuấn Kiệt, Puka"));
        listBaiHat10.addItem( new Model_BaiHat(new ImageIcon(getClass().getResource("/icon/KhamPha/mh1.jpg")), "Cục Vợ Ơi, Lấy Anh Nha","Gin Tuấn Kiệt, Puka"));
        listBaiHat11.addItem( new Model_BaiHat(new ImageIcon(getClass().getResource("/icon/KhamPha/mh1.jpg")), "Cục Vợ Ơi, Lấy Anh Nha","Gin Tuấn Kiệt, Puka"));
        listBaiHat12.addItem( new Model_BaiHat(new ImageIcon(getClass().getResource("/icon/KhamPha/mh1.jpg")), "Cục Vợ Ơi, Lấy Anh Nha","Gin Tuấn Kiệt, Puka"));
        listBaiHat13.addItem( new Model_BaiHat(new ImageIcon(getClass().getResource("/icon/KhamPha/mh1.jpg")), "Cục Vợ Ơi, Lấy Anh Nha","Gin Tuấn Kiệt, Puka"));
        listBaiHat14.addItem( new Model_BaiHat(new ImageIcon(getClass().getResource("/icon/KhamPha/mh1.jpg")), "Cục Vợ Ơi, Lấy Anh Nha","Gin Tuấn Kiệt, Puka"));
        listBaiHat15.addItem( new Model_BaiHat(new ImageIcon(getClass().getResource("/icon/KhamPha/mh1.jpg")), "Cục Vợ Ơi, Lấy Anh Nha","Gin Tuấn Kiệt, Puka"));
        listBaiHat16.addItem( new Model_BaiHat(new ImageIcon(getClass().getResource("/icon/KhamPha/mh1.jpg")), "Cục Vợ Ơi, Lấy Anh Nha","Gin Tuấn Kiệt, Puka"));
        listBaiHat17.addItem( new Model_BaiHat(new ImageIcon(getClass().getResource("/icon/KhamPha/mh1.jpg")), "Cục Vợ Ơi, Lấy Anh Nha","Gin Tuấn Kiệt, Puka"));
        listBaiHat18.addItem( new Model_BaiHat(new ImageIcon(getClass().getResource("/icon/KhamPha/mh1.jpg")), "Cục Vợ Ơi, Lấy Anh Nha","Gin Tuấn Kiệt, Puka"));
        listBaiHat19.addItem( new Model_BaiHat(new ImageIcon(getClass().getResource("/icon/KhamPha/mh1.jpg")), "Cục Vợ Ơi, Lấy Anh Nha","Gin Tuấn Kiệt, Puka"));
        listBaiHat20.addItem( new Model_BaiHat(new ImageIcon(getClass().getResource("/icon/KhamPha/mh1.jpg")), "Cục Vợ Ơi, Lấy Anh Nha","Gin Tuấn Kiệt, Puka"));
        listBaiHat21.addItem( new Model_BaiHat(new ImageIcon(getClass().getResource("/icon/KhamPha/mh1.jpg")), "Cục Vợ Ơi, Lấy Anh Nha","Gin Tuấn Kiệt, Puka"));
        listBaiHat22.addItem( new Model_BaiHat(new ImageIcon(getClass().getResource("/icon/KhamPha/mh1.jpg")), "Cục Vợ Ơi, Lấy Anh Nha","Gin Tuấn Kiệt, Puka"));
        listBaiHat23.addItem( new Model_BaiHat(new ImageIcon(getClass().getResource("/icon/KhamPha/mh1.jpg")), "Cục Vợ Ơi, Lấy Anh Nha","Gin Tuấn Kiệt, Puka"));
        listBaiHat24.addItem( new Model_BaiHat(new ImageIcon(getClass().getResource("/icon/KhamPha/mh1.jpg")), "Cục Vợ Ơi, Lấy Anh Nha","Gin Tuấn Kiệt, Puka"));
        listBaiHat25.addItem( new Model_BaiHat(new ImageIcon(getClass().getResource("/icon/KhamPha/mh1.jpg")), "Cục Vợ Ơi, Lấy Anh Nha","Gin Tuấn Kiệt, Puka"));
        listBaiHat26.addItem( new Model_BaiHat(new ImageIcon(getClass().getResource("/icon/KhamPha/mh1.jpg")), "Cục Vợ Ơi, Lấy Anh Nha","Gin Tuấn Kiệt, Puka"));
        listBaiHat27.addItem( new Model_BaiHat(new ImageIcon(getClass().getResource("/icon/KhamPha/mh1.jpg")), "Cục Vợ Ơi, Lấy Anh Nha","Gin Tuấn Kiệt, Puka"));
        listBaiHat28.addItem( new Model_BaiHat(new ImageIcon(getClass().getResource("/icon/KhamPha/mh1.jpg")), "Cục Vợ Ơi, Lấy Anh Nha","Gin Tuấn Kiệt, Puka"));
        listBaiHat29.addItem( new Model_BaiHat(new ImageIcon(getClass().getResource("/icon/KhamPha/mh1.jpg")), "Cục Vợ Ơi, Lấy Anh Nha","Gin Tuấn Kiệt, Puka"));
        listBaiHat30.addItem( new Model_BaiHat(new ImageIcon(getClass().getResource("/icon/KhamPha/mh1.jpg")), "Cục Vợ Ơi, Lấy Anh Nha","Gin Tuấn Kiệt, Puka"));
        listBaiHat31.addItem( new Model_BaiHat(new ImageIcon(getClass().getResource("/icon/KhamPha/mh1.jpg")), "Cục Vợ Ơi, Lấy Anh Nha","Gin Tuấn Kiệt, Puka"));
        listBaiHat32.addItem( new Model_BaiHat(new ImageIcon(getClass().getResource("/icon/KhamPha/mh1.jpg")), "Cục Vợ Ơi, Lấy Anh Nha","Gin Tuấn Kiệt, Puka"));
        listBaiHat33.addItem( new Model_BaiHat(new ImageIcon(getClass().getResource("/icon/KhamPha/mh1.jpg")), "Cục Vợ Ơi, Lấy Anh Nha","Gin Tuấn Kiệt, Puka"));
        listBaiHat34.addItem( new Model_BaiHat(new ImageIcon(getClass().getResource("/icon/KhamPha/mh1.jpg")), "Cục Vợ Ơi, Lấy Anh Nha","Gin Tuấn Kiệt, Puka"));
        listBaiHat35.addItem( new Model_BaiHat(new ImageIcon(getClass().getResource("/icon/KhamPha/mh1.jpg")), "Cục Vợ Ơi, Lấy Anh Nha","Gin Tuấn Kiệt, Puka"));
        listBaiHat36.addItem( new Model_BaiHat(new ImageIcon(getClass().getResource("/icon/KhamPha/mh1.jpg")), "Cục Vợ Ơi, Lấy Anh Nha","Gin Tuấn Kiệt, Puka"));
    }
