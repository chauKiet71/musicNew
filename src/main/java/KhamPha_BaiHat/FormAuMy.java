...
public class FormAuMy extends javax.swing.JPanel {
    ...
    public void init(){
        listBaiHat1.addItem( new Model_BaiHat(new ImageIcon(getClass().getResource("/icon/KhamPha/mh3.jpg")), "Cục Vợ Ơi, Lấy Anh Nha","Gin Tuấn Kiệt, Puka"));
